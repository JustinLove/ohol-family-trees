    ...
    lives.each do |life|
      if life.time > from && life.time < to
        csv << [
          ...
          life.parent,
          life.chain,
          life.birth && life.birth.time,
          life.birth && life.birth.coords[0],
          life.birth && life.birth.coords[1],
          life.death && life.death.time,
          life.death && life.death.coords[0],
          life.death && life.death.coords[1],
          life.age,
          life.cause,
          life.name_or_blank,
        ]
